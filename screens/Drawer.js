...
import { Card, CheckBox, Icon, Text, Image, Header, ListItem } from 'react-native-elements';
...
export default class Drawer extends Component{
  ...
  renderMenu(){
    const iconStyle = {color: "#FFF", type: "font-awesome", size: 18};
    const titleStyle = {color: "#FFF", fontSize: 18, fontFamily: 'sans-serif-medium'};
    const containerStyle = {backgroundColor: "#FF000000"};
    return (
      <View style={{flex: 1}}>
          <ListItem key={"trends"} title={"Trends"} onPress={()=> this.gotoPage("Trends")} leftIcon={{ name: "bar-chart", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
          <ListItem key={"profile"} title={"Profile"} onPress={()=> this.gotoPage("Profile")} leftIcon={{ name: "user-circle", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
          <ListItem key={"terms"} title={"Terms"} onPress={()=> this.gotoPage("Terms")} leftIcon={{ name: "list", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
          <ListItem key={"privacy"} title={"Privacy Policy"} onPress={()=> this.gotoPage("Privacy")} leftIcon={{ name: "file", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
          <ListItem key={"about"} title={"About Us"} onPress={()=> this.gotoPage("About")} leftIcon={{ name: "users", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
          
          <ListItem key={"logout"} title={"Logout"} onPress={this.props.logout} leftIcon={{ name: "power-off", ...iconStyle  }} titleStyle={titleStyle} containerStyle={containerStyle} />
      </View>
    );
  }
